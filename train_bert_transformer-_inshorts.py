...
news = pd.read_excel("../datasets/inshorts/data_news.xlsx", engine='openpyxl')
...
inputs = bert_encode(document, tokenizer)
...
#checkpoints
checkpoint_path = "./checkpoints_inshorts_bert"
...
def train_step(inp, tar):
    ...
    _, combined_mask, dec_padding_mask = create_masks(inp, tar_inp, False)
